package com.aries.eagle.common.utils.wordFilter.senstive;

import com.aries.eagle.common.utils.wordFilter.sensitive.SensitiveFilter;
...
//        filter.put("cao泥马");
        // 待过滤的句子
        String sentence = "是傻×汉奸傻A傻B傻Cfuck傻D汉奸傻×草泥马";
        // 进行过滤
